/*
 * Copyright 2021-2025 Brennan Shacklett and contributors
 *
...
struct Vector2 {
  ...
  inline float operator[](i32 i) const;
...
struct Mat3x3 {
  struct Transpose {
    ...
    inline Vector3 operator[](i32 i) const;
...
constexpr inline Vector3 worldUp { 0, 0, 1 };
constexpr inline Vector3 worldFwd { 0, 1, 0 };
constexpr inline Vector3 worldRight { 1, 0, 0 };
